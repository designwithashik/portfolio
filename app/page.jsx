...
As a freelance developer, I have created brand identities and site solutions for organisations and start ups, mostly in the business industry.
      ...
      {/* Projects */}
      <section>
      <h3 id='projects' className="text-3xl mb-5">PROJECTS</h3>
...
seamless payment integration, and automated seat management for an optimal learning experience.</p>
      ...
      <h2 id='contact' className='text-2xl mb-4'>CONTACT WITH ME</h2>
      ...
      <p>Whether you want to hire me, work with me on a project or just simply want to say hey, feel free to drop me a line. I'd love to chat.</p>
        <a href="mailto:ashikuzzaman099@gmail.com"><button className='px-5 py-3 bg-blue-500 rounded-full mt-5 '  >Say Hey! 👋</button></a>
        <h2 id='social' className='text-xl uppercase mt-16'>Connect with me </h2>
        <div className="flex gap-4 text-white justify-evenly mt-11">
          <Typography as="a" target='_' href="https://www.facebook.com/sheikh.ashikuzzaman.5/" className="opacity-80 transition-opacity hover:opacity-100">
          ...
          <Typography as="a" target="_" href="https://github.com/designwithashik" className="opacity-80 transition-opacity hover:opacity-100">
            <svg className="h-9 w-9" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill-rule="evenodd"
